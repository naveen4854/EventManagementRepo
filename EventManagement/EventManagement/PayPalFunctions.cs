...
namespace EventManagement
{
    public class NVPAPICaller
    {
        ...
        public string APIUsername = "naveen4854-facilitator_api1.gmail.com";
        private string APIPassword = "TRENY5EYZK5HQMB2";
        private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31ALmbUlpORJmiA0lPbAvfUw1VBFGi";
        ...
        public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
        {
            ...
            string returnURL = "https://localhost:2207/";
            string cancelURL = "https://localhost:2207/Cms";
            ...
            //    {
                    encoder["L_PAYMENTREQUEST_0_NAME0"] = "testpdt";
                    encoder["L_PAYMENTREQUEST_0_AMT0"] = "100";
